---
title: 开发总览
description: Crest v1.5.4 开发指南入口，说明源码结构、开发边界、前后端分离开发方式、构建命令和提交前检查。
---
...
开发时不要求同时改前后端。按当前任务选择最轻的链路：

| 任务 | 本地需要运行 | 可以复用 |
| --- | --- | --- |
| 改前端页面、样式、交互 | `core/core-frontend` 的 `pnpm dev` | 已部署的后端，或 `crest-service:v1.5.4` |
| 改后端接口、权限、任务、数据逻辑 | JDK 21、Maven、本地或内网 MySQL | `crest-web:v1.5.4` 前端网关 |
